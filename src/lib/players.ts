...
const STAR_BIAS: Record<string, Partial<Record<AttributeKey, number>>> = {
  ...
  "Eibhear Quilligan": { puckoutReach: 17, shotStopping: 16, highFielding: 16, composure: 15, aerialReach: 15 },
  ...
  "Cillian Duggan": { puckoutReach: 16, shotStopping: 15, passing: 16, composure: 15 },
  ...
  "Eamonn Foudy": { composure: 16, highFielding: 16, puckoutReach: 15, shotStopping: 15 },
