...
export const HELP_SECTIONS: HelpSection[] = [
  {
    ...
    paragraphs: [
      ...
      "Players over 30 can call it a day. A summer on the bench makes that likely, and more so the older they are or the lower the card. A full championship in the jersey usually keeps them. A young hurler, usually 18 to 21, can come onto the panel. If one of the really good players steps away, a promising youth arrives in his place. Panel sizes stay much the same.",
