        ...
        <section className="season-end__card" role="dialog" aria-labelledby="new-season-title">
          ...
          <p>
            {together
              ...
              : `Start the ${championship.year + 1} championship in charge of ${clubName}? The same clubs come back. Young lads who played and finished in form come on over the winter, quickly at 19 and hardly at all by 25. From 30 the attributes slip, and a summer on the bench costs more than a summer in the jersey. Some of the year's training stays on the card, more of it when they are young. Players over 30 can retire, likely if they barely played, and a young hurler can come in. A departed star is replaced by a promising youth.`}
          </p>
